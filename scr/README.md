...
## 📄 **FILE 2: main.py** (Simplified version for direct use)
...
1. Copy **FILE 2 (main.py)** above and save as `main.py`
2. Copy **FILE 3 (requirements.txt)** and save as `requirements.txt`
3. Copy **FILE 1 (README.md)** and save as `README.md`
...
```bash
python main.py --input DataProc.csv --output my_results
```

### **Step 4: View results**
- Check `my_results/` directory for CSV files
- Open `README.md` for complete documentation with all actual numbers
